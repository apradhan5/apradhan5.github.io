...
export default function App() {
  ...
  const handleOpenAgentforce = () => {
    ...
    window.initEmbeddedMessaging = () => {
      try {
        ...
        window.embeddedservice_bootstrap.init(
          '00Daj00000mC8UP',
          'AP_Portfolio_Web_Deployment',
          'https://infobeans-11a-dev-ed.develop.my.site.com/ESWAPPortfolioWebDeplo1777118830625',
          {
    ...
    script.src = 'https://infobeans-11a-dev-ed.develop.my.site.com/ESWAPPortfolioWebDeplo1777118830625/assets/js/bootstrap.min.js';
    script.onload = () => {
